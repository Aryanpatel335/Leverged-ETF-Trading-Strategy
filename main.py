...
# if adj close is between 0 - 1.5% or -1.5-0 we wiill buy in that direction for next day, if the pct change is greater than 1.5 in any direction we will buy in opposite direction for next day 
